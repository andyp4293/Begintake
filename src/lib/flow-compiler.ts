    ...
    switch (node.type) {
      ...
      case 'transfer': {
        ...
        if (isParalegal) {
          ...
          sections.push('STEP 1: Say "One moment while I send your information over and check on availability for you."');
          sections.push('STEP 2: Immediately call generateTransferSummary with transferTarget="attorney" and ALL collected data:');
